...
width and height, property and
setter for both, methods to
calculate area and perimeter,
string representation method,
an official string representation method,
and a destructor to print a
...
class Rectangle:
    ...
    and methods to calculate area and
    perimeter, provide string representations,
